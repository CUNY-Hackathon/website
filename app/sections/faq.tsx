...
export default function Faq() {
  ...
  return (
    <div id="faq" className={"p-8 min-h-[500px] text-center text-4xl bg-black text-white " + Fredericka.className}>
        {/* FAQ Header */}

      <h1 className={"text-6xl mb-10 text-center "  + Fredericka.className}>FAQs</h1>
